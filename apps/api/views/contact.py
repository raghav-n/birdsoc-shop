...
class ContactFormAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            email_body = render_to_string('django_contact_form/emails/contact_form.html', context)
            email_subject = render_to_string('django_contact_form/emails/contact_form_subject.txt', context).strip()
            ...
            logger.info(f"Contact form submission sent from {email} with subject: {subject}")
