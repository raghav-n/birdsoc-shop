...
class SelfCollectHW2024(methods.NoShippingRequired):
    ...
    description = (
        "<p>Please collect your merchandise from our booth at Henderson Waves on 20 October, 27 October, 3 November, or 10 November.</p>"
        "<p><strong>Unfortunately, we are unable to offer refunds for items left unclaimed after 10 November.</strong></p>"
    )
    email_description = (
        "Your items can be collected from our Raptor Watch booth at Henderson Waves on 20 October, 27 October, 3 November, or 10 November. "
